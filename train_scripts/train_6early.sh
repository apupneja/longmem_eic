...
CKPT_DIR=/data/zyu401_data/anirudh/longmem_data/train_ckpt/6early/again
PTM_PATH=/data/zyu401_data/anirudh/longmem_data/LongMem_public_checkpoints/gpt2_medium/checkpoint_last.pt

CUDA_VISIBLE_DEVICES=4,5,6,7 TORCH_DISTRIBUTED_DEBUG=DETAIL fairseq-train ${DATA_DIR}  \
    --save-dir ${CKPT_DIR} \
