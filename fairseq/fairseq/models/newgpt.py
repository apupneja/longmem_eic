...
class NewGPTLanguageModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--retrieval-layer-index', type=int, metavar='N',
                            ...
                            default="17")
        parser.add_argument('--precompute-mem-layer', type=int, metavar='N',
                            help='The layer index for retrieval',
                            default="0")
...
class NewGPTDecoder(FairseqIncrementalDecoder):
    def __init__(self, args, task):
        ...
        config = NewGPTConfig(
            ...
            precompute_mem_layer = args.precompute_mem_layer,
...
def default_architecture(args):
    ...
    args.precompute_mem_layer = getattr(args, "precompute_mem_layer", 0)
