...
class TransformerSideNetConfig(FairseqDataclass):
    ...
    precompute_mem_layer: Optional[int] = field(
        default=0,
        metadata={"help": "The number of layers before the JointAttention, where we retreive the context from the Memory Bank"},
    )
